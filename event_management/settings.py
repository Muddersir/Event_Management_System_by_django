...
DATABASES = {
    'default': dj_database_url.config(
        ...
        default='postgresql://event_management_db_m1my_user:SvEWtuxvgNf5ouLgNELtBbn2Vc6H0APf@dpg-d4omgt3e5dus73ccc9l0-a.oregon-postgres.render.com/event_management_db_m1my',
       conn_max_age=600
    )
}
